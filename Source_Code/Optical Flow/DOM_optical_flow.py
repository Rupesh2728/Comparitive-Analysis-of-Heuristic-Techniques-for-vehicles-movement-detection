...
# trained_gmm = extract_background(video_path)
count = 0
mask = [[]]
...
while count < 400:
    ...
    if len(trajectories) > 0:
        ...
        for trajectory in direction_trajectories['top']:
        ...
        for trajectory in direction_trajectories['down']:
            for pt in trajectory:
