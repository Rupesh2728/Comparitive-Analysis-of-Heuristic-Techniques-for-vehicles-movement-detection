import cv2
import numpy as np
from sort import Sort  # Ensure SORT library is installed
import csv
import sys
...
def save_boundaries_to_csv(boundaries, road_boundaries, output_csv, direction_count):
    with open(output_csv, 'w', newline='') as file:
        ...
        writer.writerow(['Frame', 'Min_Left', 'Max_Left', 'Min_Right', 'Max_Right', 'Min_Top', 'Max_Bottom'])
        writer.writerows(boundaries)
        writer.writerow([])
        writer.writerow(['Vehicle_ID', 'X1', 'Y1', 'X2', 'Y2'])
        writer.writerows(road_boundaries)
        writer.writerow([])
